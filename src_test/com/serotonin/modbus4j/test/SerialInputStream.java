...
public class SerialInputStream extends InputStream {
    ...
    public int read(byte[] buf, int offset, int length) throws IOException {
        ...
        //其中在SerialInputStream.java.java类中的125行中System.arraycopy(readBuf, 0, buf, offset, length);
        //length值会导致数组越界错误，把此处改为 System.arraycopy(readBuf, 0, buf, offset, readBuf.length);即可
        //作者：雨中的单车,https://www.jianshu.com/p/32575c9c4e54
